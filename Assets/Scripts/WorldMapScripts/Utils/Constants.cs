...
namespace WorldMap
{
    public class Constants : MonoBehaviour
    {
        ...
        public const int STARTING_GOLD = 30;
        public const int STARTING_FOOD = 30;
        public const int UNIT_FOOD_EAT_COST = 3;
        public const int KING_FOOD_EAT_COST = 3;
        ...
        public const int VORONOI_POLYGON_NUMBER = 40;
