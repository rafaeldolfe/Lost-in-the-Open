...
namespace Utils
{
    ...
    public class PlainGameObject
    {
        ...
        public T GetProperty<T>(Type type, string propertyName)
        {
            ...
            //T prop = default(T);
            //JObject propJson = null;
            //try
            //{
            //    prop = (T) props.properties[propertyName];

            //    Debug.Log($"prop: {prop}");

            //    Debug.Log($"/////////////////////DONE FOR THIS CALL!//////////////////");
            //}
            //catch
            //{
            //    Debug.Log($"type: {type}, propertyName: {propertyName}");
            //    Debug.Log($"props: {props}");
            //    Debug.Log($"props.properties[propertyName]: {props.properties[propertyName]}");
            //    Debug.Log($"props.properties[propertyName].GetType(): {props.properties[propertyName].GetType()}");
            //}
            //try
            //{
            //    propJson = (JObject)props.properties[propertyName];
            //    Debug.Log($"propJson: {propJson}");
            //    Debug.Log($"/////////////////////DONE FOR THIS CALL!//////////////////");
            //    prop = propJson.ToObject<T>();
            //}
            //catch
            //{

            //    Debug.Log($"prop: {prop}");
            //    throw new Exception($"Invalid parameters, propertyName {propertyName} in class {type} does not exist");
            //}
            //return prop;
